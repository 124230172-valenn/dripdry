<?php
session_start();
include 'db.php'; // pastikan file db.php ada di folder owner
...
// Ambil data booking bulan itu (sudah dikirim admin/staff)
...
<title>Laporan Bulanan - Owner</title>
...
<header class="header">
    <div class="header-content">
        ...
        <div class="nav-buttons">
            <a href="dashboard_owner.php" class="nav-btn">
...
<div class="total center">Total Pendapatan: Rp <?= number_format($totalPendapatan,0,',','.') ?></div>

<?php else: ?>
<p class="center">Belum ada laporan bulanan untuk bulan ini.</p>
<?php endif; ?>
